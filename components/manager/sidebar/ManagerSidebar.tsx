...
export default function ManagerSidebar() {
  ...
  return (
    <TooltipProvider delayDuration={120}>
      <aside
        className={cn(
          "sticky top-0 flex h-dvh flex-col border-r border-slate-700/60 bg-gradient-to-br from-slate-900 via-slate-800 to-cyan-900",
          isCollapsed ? "w-[72px]" : "w-[220px]",
        )}
      >
        <div className={cn("border-b border-slate-700/50 px-2 py-3", isCollapsed ? "flex justify-center" : "flex justify-end")}>
          <Tooltip>
